 ...
 * round constants
 */
static unsigned char RC[] = {0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36};
 ...
 * We do use mul2(int8_t a) but not mul(unsigned char a, unsigned char b)
 * just in order to get a higher speed.
 */
static inline unsigned char mul2(unsigned char a)
{
